...
class AuditEventType:
    ...
    POLICY_DECISION = "POLICY_DECISION"      # More specific: records the decision outcome
    HUMAN_APPROVAL_REQUESTED = "HUMAN_APPROVAL_REQUESTED"
    HUMAN_APPROVED = "HUMAN_APPROVED"
    HUMAN_REJECTED = "HUMAN_REJECTED"
    
    # Agent Actions
    BUYER_TOOL_INVOKED = "BUYER_TOOL_INVOKED"
    BUYER_OFFER = "BUYER_OFFER"
    MERCHANT_DECISION = "MERCHANT_DECISION"   # Merchant chose action (accept/counter/reject)
    MERCHANT_TOOL_INVOKED = "MERCHANT_TOOL_INVOKED"
